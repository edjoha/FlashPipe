rule samtools:
    input: "{TEMPDIR}/bam/{run}_FSLA_{cond}_{sample}_Aligned.sortedByCoord.out.bam"   
    output: "{TEMPDIR}/bam/filtered/{run}_FSLA_{cond}_{sample}_Aligned.sortedByCoord.filtered.bam"
...
rule star:
    ...
    output: "{TEMPDIR}/bam/{run}_FSLA_{cond}_{sample}_Aligned.sortedByCoord.out.bam"
    conda: "../envs/alignment.yaml"
    params:
